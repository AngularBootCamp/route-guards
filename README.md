# DRAFT - Angular Boot Camp Curriculum - route-guards
...
[StackBlitz for route-guards](https://stackblitz.io/github/AngularBootCamp/route-guards)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/route-guards.git
cd route-guards
yarn
yarn start
```
